...
float lightPos[3] = { 1.1f, 1.0f, 1.3f };
...
//int verticeNumber = 3;
/*TODO: Maybe create another array, or figure out the appropriate scale 
...
{ 
	...
	glUniform3fv(lightVec, 3, lightPos);
}
void kValues() 
{	
	GLint kLocation = glGetUniformLocation(program, "k");
	glUniform3fv(kLocation, 3, k);
}
void viewerPos()
{
