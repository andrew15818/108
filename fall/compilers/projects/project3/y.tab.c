...
static const yytype_uint16 yyrline[] =
{
     ...
     110,   116,   123,   129,   135,   147,   156,   170,   176,   183,
     190,   203,   207,   212,   223,   228,   231,   236,   241,   244,
     247,   253,   258,   262,   270,   276,   280,   285,   294,   297,
     305,   308,   313,   321,   325,   332,   336,   343,   347,   355,
     361,   369,   373,   377,   382,   387,   393,   397,   403,   408,
...
#line 1479 "y.tab.c" /* yacc.c:1646  */
  ...
  case 8:
#line 91 "first.y" /* yacc.c:1646  */
    {
		(yyval.node) = newNode(array);
		(yyval.node)->specificType = array;
		addNewChild((yyval.node), (yyvsp[0].node));	
...
#line 1571 "y.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 156 "first.y" /* yacc.c:1646  */
    {
		(yyval.node) = newNode(procedure);
		//printf("procedure type is : %d\n", $$->type);
		(yyval.node)->specificType = procedure;
		(yyval.node)->name = (char*)malloc(strlen((yyvsp[-2].node)->name+1));
		strcpy((yyval.node)->name, (yyvsp[-2].node)->name);
