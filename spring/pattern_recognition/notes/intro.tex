...
\section{Regression}
	...
	\end{itemize}
	Remember the basis functions describe the probability of every observation in our $x$ vector.

	Given an input vector $X$, and a set of target values $t$, and a precision $\beta$, our
	likelihood function is:\footnote{Essentially, this formula says that the 
